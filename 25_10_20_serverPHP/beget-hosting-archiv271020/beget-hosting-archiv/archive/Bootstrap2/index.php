...
<html lang="ru">
  <head>
    ...
    <title>Контакты Тест Реушенов Абай</title>
  </head>
  <body>
    ...
    <div class="container text-center py-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <i class="fas fa-space-shuttle fa-10x"></i>
          <p class="h2">Космический корабль-челнок</p>
        </div>
        <div class="col-md-4">
          <i class="fas fa-sign-language fa-10x"></i>
          <p class="h2">Аплодисменты</p>
        </div>
      </div>
    </div>
...
<!--     яндекс карта -->
    <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Ad6bcbc93675fe989888897cd735fb4920112e4bd1a1411afa6f98b1de02080a4&amp;width=699&amp;height=645&amp;lang=ru_RU&amp;scroll=true"></script>
    <!-- Конец яндекс карты -->
